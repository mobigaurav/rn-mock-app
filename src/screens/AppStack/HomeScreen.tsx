...
import { fetchUsersData } from '../../redux/ducks/userdata';
import { selectAllUsers, selectStatus } from '../../redux/ducks/userdata';
...
const HomeScreen = ({ navigation }: HomeScreenProps): React.ReactElement => {
    ...
    const users = useReduxSelector(selectAllUsers)
    const postStatus = useReduxSelector(selectStatus)
    useEffect(() => {
        if(postStatus == 'init') {
